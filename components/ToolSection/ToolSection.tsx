    ...
    <section className={styles.toolSection}>
      ...
      <div className={styles.toolSection__cards}>
        <div className={styles.toolCard}>
          ...
          <Button text="Open Builder" variant="soft" onClick={() => router.push('/ontology-playground')} />
        </div>
        ...
        <div className={styles.toolCard}>
          ...
          <Button text="Start Querying" variant="soft" onClick={() => router.push('/SPARQL-playground')} />
        </div>
      </div>
