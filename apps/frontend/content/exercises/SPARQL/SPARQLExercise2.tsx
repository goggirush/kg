...
const SPARQLExercise1 = () => {
  ...
  const [query, setQuery] = useState(`SELECT ?o {
    ?s ?p ?o .
  }`);
  ...
  return (
    <>
      ...
      slide to see how we can narrow down our search.
       ...
       :
       <p>
       The pre-defined sparql-query below fetches all the <strong>objects</strong> from our knowledge graph. Your assignment is to update the sparql-query to instead
       fetch all the <strong>subjects</strong>.
    ...
    <div className={styles.toggleViewContainer}>
      ...
      <div className={styles.wrapper}>
        <div style={{flex: .4}}>
          ...
          <Editor onChange={(value) => setQuery(value)} defaultLanguage="sql" defaultValue={query} height="320px" options={{
            fontSize: 12,
